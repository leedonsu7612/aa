	...
	<div id="wrap">
		<div id="container">
			<div id="contents">
				...
				<!-- 검색조건 -->
				<form id="searchForm" name="searchForm" class="mt20" action="<c:url value='/buyer/setOff/list.do'/>" method="post">
				...
				<table id="resultTable" class="tbl_view2 mb10" summary="상계지급 승인요청 조회 상세 현황입니다.">
				...
				<!-- 상세 페이지 URL -->
				<input id="detailUrl" type="hidden" value="/buyer/salesBilling/list.do" />
				<!-- // 상세 페이지 URL -->
	...
	<script type="text/javascript">
		...
		$(function() {
			...
			$("#alert_popup").find(".btn_ok").click(function(){
				...
				if(flag == "3"){ // 지급 승인
					authorizedAjax("<c:url value='/buyer/setOff/approve.json'/>", ajaxData);
				}else if(flag = "2"){ // 지급 취소
					authorizedAjax("<c:url value='/buyer/setOff/reject.json'/>", ajaxData);
				}else{
					return;
				}
			});
