...
<body class="main" style="">
	...
	<div id="wrap">
		<div id="container">
			<div id="contents">
				<!-- title -->
				<h2 class="hidden">지급현황(상세)</h2>
				<!-- // title -->

				<!-- 검색조건 -->
				<form id="searchForm" class="mt20" action="<c:url value='/buyer/salesBilling/list.do'/>" method="post">
				...
				<table id="storeInfoTable" class="tbl_view2 mt15 mb15" summary="대리점 상세정보표 입니다.">
					...
					<tbody>
						<tr>
							<th scope="row" class="tbl_center">대리점</th>
				...
				<!-- 거래내역 -->
				<h3 class="hidden">대리점 거래내역</h3>
				<table id="transactionTable" class="tbl_view2 mb20" summary="대리점 거래내역 상세정보 입니다.">
					<caption>대리점 거래내역 정보</caption>
					<thead>
						<tr>
							<th class="tbl_center" scope="col">년월</th>
							<th class="tbl_center" id="purchase" scope="col">매입내역</th>
							<th class="tbl_center" scope="col">세금계산서<br>발행금액</th>
							<th class="tbl_center" id="provide" scope="col">총지급내역</th>
							<th class="tbl_center" scope="col">만기일 지정 지급</th>
							<th class="tbl_center" id="etc_provide" scope="col">기타지급</th>
							<th class="tbl_center" id="setoff" scope="col">상계수금</th>
							<th class="tbl_center" id="non-payment" scope="col">미지급금</th>
						...
						<c:choose>
							...
							<c:otherwise>
								...
								<tr>
									...
									<td class="money_right"><fmt:formatNumber value="${item.extraAmountOk }" pattern="#,###" /></td>
									<td class="money_right"><fmt:formatNumber value="${item.setoffOk}" pattern="#,###" /></td>
				...
				<!-- 만기일 미지정 금액 클릭 -->
				<form id="unpayItem" action="<c:url value='/buyer/accountReceivable/list.do'/>" method="post">
				...
				<!-- 총지급내역 클릭 -->
				<form id="inquiryForm" action="<c:url value='/buyer/salesBilling/list.json'/>" method="post">
				...
				<!-- 결제대기 클릭 -->
				<input type="hidden" id="detailUrl" value="<c:url value='/buyer/salesBilling/detail.do'/>">
				<!-- // 결제대기 클릭 -->
