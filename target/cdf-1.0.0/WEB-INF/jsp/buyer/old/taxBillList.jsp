	...
	<div id="wrap">
		<div id="container">
			<div id="contents">
				...
				<!-- 검색조건 -->
				<form name="searchForm" method="post" id="searchForm" class="mt20" action="<c:url value='/buyer/taxBill/list.do'/>">
				...
				<!-- 세금계산서 등록 조회 -->
				<form id="searchPopup" action="/buyer/taxBill/list.do" method="post"></form>
				...
				<!-- 세금계산서 팝업 URL -->
				<input type="hidden" id="taxBillPopupUrl" value="<c:url value='/buyer/taxBill/popup.do'/>">
				<!-- 세금계산서 팝업 URL -->

				<form id="taxBillForm" method="post" action="<c:url value='/buyer/taxBill/popup.do'/>">
