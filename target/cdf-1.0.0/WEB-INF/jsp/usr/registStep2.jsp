...
<script type="text/javascript">
	...
	$(function()
	{
	    $("#nextStep").click(function()
	    {
	        ...
	        {
	            $("#bizNumError > .msg-txt").text("부도시 세금계산서 채권만기일 지정에 따른 동의에 체크해 주십시오.");
	            $("#bizNumError").css("visibility", "visible");
	            $("#bizNumError").fadeIn("slow");
...
② 회사는 필요한 경우 이 약관을 변경할 수 있으며, 약관이 변경되는 경우에는 그 시행일의 최소한 7일전에 1항과 같은 방법으로 공시한다.
			...
			<div class="agr-bx">
				<strong>부도시 세금계산서 채권만기일 지정에 따른 동의</strong>
				<textarea>
1 장 총칙
...
② 회사는 필요한 경우 이 약관을 변경할 수 있으며, 약관이 변경되는 경우에는 그 시행일의 최소한 7일전에 1항과 같은 방법으로 공시한다.
				...
				<p><input type="checkbox" id="agree3" /><label for="agree3"><span></span>부도시 세금계산서 채권만기일 지정에 따른 동의에 동의합니다.</label></p>
			</div>
