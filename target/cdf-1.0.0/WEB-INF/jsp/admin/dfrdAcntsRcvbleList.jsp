...
<%
  /**
  * @Class Name : dfrdAcntsRcvbleList.jsp
  * @Description : 매출채권 List 화면
...
<script type="text/javascript">
    ...
    function linkPage(pageNo){
		...
		document.searchForm.action = "<c:url value='/admin/dfrdAcntsRcvbleList.do'/>";
        ...
        <div id="pop_container">
			...
			<form:form commandName="searchVO" id="searchForm" name="searchForm" class="mt20" method="post">    
				...
				<div class="category">
					<!-- tab menu -->
					<ul>
						<li><a href="#NONE" class="active" id="tab01" onClick='gotoPage("<c:url value='/admin/dfrdAcntsRcvbleList.do'/>");'>매출채권</a></li>
