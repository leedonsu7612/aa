...
<form:form commandName="searchVO" id="searchForm" name="searchForm" class="mt20" method="post">    
	...
	<div class="tab-contents">
		<!-- tab menu -->
		<ul>
			<li class="active"><a href="#NONE" id="tab01" onClick='gotoPage("<c:url value='/admin/dfrdAcntsRcvbleList.do'/>");'>매출채권</a></li>
	...
	<!-- 매출채권 조회 -->
	<h3 class="hidden">매출채권 조회</h3>
    <table class="tbl_view2 mb10 mt15" summary="매출채권 검색내역입니다.">
        <caption>매출채권 조회</caption>
		<thead>
			<!-- 테이블 헤드 -->
			<tr>
				<th class="tbl_center" scope="col">No</th>
				<th class="tbl_center" scope="col">매출채권번호</th>
