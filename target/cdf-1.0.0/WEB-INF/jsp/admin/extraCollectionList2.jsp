...
<form:form commandName="searchVO" id="searchForm" name="searchForm" class="mt20" method="post">    
	...
	<div class="tab-contents">
		...
		<ul>
			...
			<li class="active"><a href="#NONE" id="tab02" onClick='gotoPage("<c:url value='/admin/extraCollectionList.do'/>");'>기타수금</a></li>
	...
	<!-- 기타수금 조회 -->
	<h3 class="hidden">기타수금 조회</h3>
    <table class="tbl_view2 mb10 mt15" summary="기타수금 검색내역입니다.">
        <caption>기타수금 조회</caption>
		<thead>
			<!-- 테이블 헤드 -->
			<tr>
				<th class="tbl_center" scope="col">No</th>
				<th class="tbl_center" scope="col">기타수금번호</th>
