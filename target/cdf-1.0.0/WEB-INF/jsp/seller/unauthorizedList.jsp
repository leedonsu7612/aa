...
<body>
	<div id="wrap">
		...
		<div id="container" class="agency">
			<div id="contents">
				...
				<form action="<c:url value='/seller/unauthorized/list.do'/>" method="post" name="searchForm" id="searchForm">
				...
				<div class="tbl-type01 basic">
					<table summary="기타수금 요청입니다.">
						<caption>기타수금 요청</caption>
						<colgroup>
							<col width="8%">
							<col width="12%">
							<col width="12%">
	...
	<!-- 기타수금 요청 폼 -->
	<form action="<c:url value='/seller/unauthorized/request.do'/>" method="post" name="requestForm" id="requestForm">
	...
	<script>
		...
		var REQUEST_URL = "/seller/unauthorized/request.do"; // 수금 요청 URL
		...
		$(function() {
			...
			$("#requestPopup").on("click", ".ok", function(){
				...
				doAjax(ajaxUrl, jsonData, function(){
					openAlert("기타수금 요청이 완료되었습니다.", submitSearchForm);
				});
