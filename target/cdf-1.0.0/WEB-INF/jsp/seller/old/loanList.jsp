...
<body class="main">
	...
	<div id="wrap">
		<div id="container">
			<div id="contents">
				<!-- title -->
				<h2 class="hidden">대출 가능 채권 조회</h2>
				<!-- // title -->

				<!-- 검색조건 -->
				<form name="searchForm" method="post" id="searchForm" class="mt20" action="<c:url value='/seller/loan/list.do'/>">
				...
				<!-- 대출 가능 채권조회 -->
				<h3>대출 가능 채권조회</h3>
				<table id="ariTable" class="tbl_view2 mb10" summary="대출 가능 채권 조회입니다.">
					<caption>대출 가능 채권조회</caption>
					<colgroup>
						<col width="5%" />
						<col width="15%" />
						<col width="5%" />
					...
					<thead>
						<tr>
							...
							<th class="tbl_center" scope="col">대출실행</th>
						</tr>
					</thead>
				...
				<!-- 상세 페이지 URL -->
				<input type="hidden" id="detailUrl" value="<c:url value='/seller/salesBilling/list.do'/>" />
				<!-- // 상세 페이지 URL -->
				...
				<!-- 결제대기 클릭 -->
				<input type="hidden" id="payPopUrl" value="/seller/salesBilling/detail.do">
				<!-- // 결제대기 클릭 -->
