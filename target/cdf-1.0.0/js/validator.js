...
function validateDealApprove(form) 
            {
                var isValid = true;
                var columnLength = 0;
                var row = 0;
                ...
                for ( row = 0; row <= 4; row++) 
                {
                    if ( $("#amountOfMoney" + ( row + 1 ) ).val() != "" ) 
                    {
                        columnLength++;
                    }
                    if ( $("#expirationDate" + ( row + 1 ) ).val() != "" )
                    {
                        columnLength++;
                    }
                    if ( $("#expirationAvg" + ( row + 1 ) ).val() != "" )
                    {
                        columnLength++;
                    }
                    ...
                    {
                        //??? ???? ?? length? 0??? 3??? ??  
                        if ( !( columnLength == 0 || columnLength == 3 ) ) 
                        {
                            if ( $("#amountOfMoney" + ( row + 1 ) ).val() == "" ) 
                            {
                                //alert( "??? ??? ???." );
                            }
                            else if ( $("#expirationDate" + ( row + 1 ) ).val() == "" )
                            {
                                //alert( "???? ??? ???." );
                            }
                            else if ( $("#expirationAvg" + ( row + 1 ) ).val() == "" )
                            {
                                //alert( "??? ??? ???." );
                            }
