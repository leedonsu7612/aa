...
<div id="header">
	<div class="header">        
		...
		<ul class="global_menu">
			<li class="on"><a href="<c:url value='/admin/checkMemberList.do'/>">품목/대리점 조회</a></li>
...
<form:form commandName="searchVO" id="searchForm" name="searchForm" class="mt20" method="post">    
	...
	<!-- 사업자 목록 조회 -->
	<h3 class="hidden">회원목록  조회</h3>
    <table class="tbl_view2 mb10 membinfo" summary="회원목록 검색내역입니다.">
        ...
        <thead> <!-- 테이블 헤드 -->
            <tr>
                ...
                <th class="tbl_center" scope="col">연체중</th>
            </tr>
        </thead>
        ...
        <tbody>
     			<c:forEach var="result" items="${resultList}" varStatus="status">
                     <tr>
                         ...
                         <td class="text_center" onclick="accessCompany('${result.businessNo}', '${result.membClass}')">
                         ...
                         <td class="text_center bsrn6268100403">
                         </td>
                     </tr>
                 </c:forEach>
         </tbody>
