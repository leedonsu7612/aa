...
<script type="text/javascript">
    ...
    function linkPage(pageNo){
		...
		document.searchForm.action = "<c:url value='/admin/taxbillList.do'/>";
...
<form:form commandName="searchVO" id="searchForm" name="searchForm" class="mt20" method="post">    
	...
	<div class="tab-contents">
		...
		<ul>
			...
			<li class="active"><a href="#NONE" id="tab04" onClick='gotoPage("<c:url value='/admin/taxbillList.do'/>");'>세금계산서</a></li>
    ...
    <table class="tbl_view2 mb10 mt15" summary="세금계산서 검색내역입니다.">
