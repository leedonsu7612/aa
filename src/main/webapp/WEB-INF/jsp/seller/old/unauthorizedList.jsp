...
<%
	...
	* @Description : 품목점 기타지급 승인 List 화면
	...
	<div id="wrap">
		<div id="container">
			<div id="contents">
				...
				<!-- 검색조건 -->
				<form name="searchForm" method="post" id="searchForm" class="mt20" action="<c:url value='/seller/unauthorized/list.do'/>">
				...
				<table id="unauthorizedTable" class="tbl_view2 mb10" summary="기타지급 승인요청 조회 상세 현황입니다.">
					...
					<tbody>
						<c:choose>
							...
							<c:otherwise>
								...
								<tr>
									<td id="idx" class="text_center" amountOfMoney="${item.amount }" taxBillNumber="${item.taxbillNo }" transactionNumber="${item.transactionNo }">${status.count }</td>
									...
									<td class="text_center businessName" id="store_name${status.index }" businessNumber="${item.seller.businessNo }">
										<a href="javascript:;" onclick="linkToSalesBilling( '${item.seller.businessNo }' )">
				...
				<div id='alert_popup1' class="alert_popup">
					<dl>
						<dt>승인처리 하시겠습니까?</dt>
						<dd>
							<span class="btn btn_normal popokbtn"><a id="extraAmountOk" href="javascript:;" style="width: 80px;">확인</a></span>
							<span class="btn btn_normal popokbtn"><a id="extraAmountCancel" href="javascript:;" style="width: 80px;">취소</a></span>
						</dd>
					</dl>
				</div>
				
				<form id="insertItem" action="<c:url value='/seller/unauthorized/insert.json'/>" method="post">
				...
				<div id='alert_popup2' class="alert_popup">
					<dl>
						<dt>취소처리 하시겠습니까?</dt>
						<dd>
							<span class="btn btn_normal ok_btn01"><a id="extraAmountRemoveOk" href="javascript:;" style="width: 80px;">확인</a></span>
							<span class="btn btn_normal popokbtn"><a id="extraAmountRemoveCancel" href="javascript:;" style="width: 80px;">취소</a></span>
						</dd>
					</dl>
				</div>
				
				<form id="extraDeleteItem" action="<c:url value='/seller/unauthorized/delete.json'/>" method="post">
					<input id="taxBillNumber" name="taxBillNumber" type="hidden" value="" />
					<input id="transactionNumber" name="transactionNumber" type="hidden" value="" />
