...
<%
  /**
  * @Class Name : searchId.jsp
  * @Description : 아이디찾기 화면
					...
					<tbody>
						<tr>
							...
							<td>
								...
								<a href="#" class="btn-submit" onClick="javascript:TimerStart();">인증번호 발송</a>
						...
						<tr>
							...
							<td><input type="text" class="wx230" />
								...
								<span id="remTime">인증유효 남은시간 03:00</span>
							</td>
						</tr>
					</tbody>
				</table>
...
<div id="noticePop" class="acc2-pop">
	<div class="msg-txt">
		회원님의 아이디는 mob*** 입니다.
	</div>
	<div class="btn-set2">
