...
/**
 * @Class Name : SellerPaymentServiceImpl.java
 * @Description : seller Payment Business Implement Class
...
public class PaymentServiceImpl extends EgovAbstractServiceImpl implements PaymentService {
	...
	public List<PaymentVO> selectSellerPaymentList(Map<String, Object> params) throws Exception {
		List<PaymentVO> list = paymentDAO.selectSellerPaymentList(params);
	...
	public int selectSellerPaymentListCnt(Map<String, Object> params) throws Exception {
		return paymentDAO.selectSellerPaymentListCnt(params);
	}
	...
	public int selectSellerPaymentSummary(Map<String, Object> params) throws Exception {
		return paymentDAO.selectSellerPaymentSummary(params);
	}
