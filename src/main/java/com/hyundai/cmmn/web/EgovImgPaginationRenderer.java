...
*/
		firstPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\" class=\"first\">처음</a>";
		previousPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\" class=\"prev\">이전</a>";
		currentPageLabel = "<span>{0}</span>";
		otherPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\">{2}</a>";
		nextPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\" class=\"next\">다음</a>";
		lastPageLabel = "<a href=\"#\" onclick=\"{0}({1}); return false;\" class=\"last\">맨끝</a>";
	}
